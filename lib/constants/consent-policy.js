/**
 * Consent Policy Text for Otters Kenya Academy of Swimming Limited
 * Shared constant for both client and server components
 */
export const CONSENT_POLICY_TEXT = `By registering with Otters Kenya Academy of Swimming Limited:
...
4. I acknowledge that registration is only complete upon payment of the non-refundable annual registration fee of KES 3,000.`
