 ...
 * @param {{ parent_id: string, type: string, title: string, body?: string, swimmer_id?: string, invoice_id?: string, session_id?: string }} payload
 */
export async function insertNotification(supabase, {
  parent_id,
  type,
  title,
  body,
