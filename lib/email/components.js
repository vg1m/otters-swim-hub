...
<p style="margin:0 0 16px;font-size:13px;color:${EMAIL_TOKENS.textSubtle};font-family:${EMAIL_TOKENS.fontFamily};">
...
export function emailLinkLine(href) {
  const url = escapeHtml(href)
  return `<p style="margin:0 0 16px;font-size:13px;color:${EMAIL_TOKENS.textSubtle};font-family:${EMAIL_TOKENS.fontFamily};">
