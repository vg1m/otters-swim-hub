      ...
      <div className="min-h-screen bg-gray-50 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            ...
            <p className="text-gray-600 mt-2">Otters Kenya Swim Club Management</p>
          </div>

          {/* Stats Cards */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <Card padding="normal" className="bg-blue-50 border-blue-200">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-blue-600 font-medium">Pending Registrations</p>
                  <p className="text-3xl font-bold text-blue-900 mt-2">{stats.pendingRegistrations}</p>
                </div>
            ...
            <Card padding="normal" className="bg-green-50 border-green-200">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-green-600 font-medium">Active Swimmers</p>
                  <p className="text-3xl font-bold text-green-900 mt-2">{stats.activeSwimmers}</p>
                </div>
            ...
            <Card padding="normal" className="bg-yellow-50 border-yellow-200">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-yellow-600 font-medium">Outstanding</p>
                  <p className="text-2xl font-bold text-yellow-900 mt-2">{formatKES(stats.outstandingInvoices)}</p>
                </div>
            ...
            <Card padding="normal" className="bg-purple-50 border-purple-200">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-purple-600 font-medium">This Week's Check-ins</p>
                  <p className="text-3xl font-bold text-purple-900 mt-2">{stats.weeklyAttendance}</p>
                </div>
